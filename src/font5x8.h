...
{0x00,0x70,0x2a,0x29,0x2a,0x70},   // Ś 0x8c 140
...
{0x00,0x00,0x46,0x7d,0x46,0x00},   // ś 0x9c 156
{0x00,0x00,0x45,0x7c,0x45,0x00},   // ? 0x9d 157
{0x00,0x00,0x48,0x7a,0x41,0x00},   // ~ 0x9e 158
{0x00,0x00,0x49,0x7a,0x40,0x00},   // ź 0x9f 159
{0x00,0x00,0x4a,0x79,0x42,0x00},   //   0xa0 160
{0x00,0x00,0x49,0x78,0x41,0x00},   // ˇ 0xa1 161
{0x00,0x38,0x44,0x46,0x45,0x38},   // ˘ 0xa2 162
{0x00,0x38,0x45,0x46,0x44,0x38},   // Ł 0xa3 163
{0x00,0x38,0x46,0x45,0x46,0x38},   // ¤ 0xa4 164
{0x00,0x38,0x45,0x44,0x45,0x38},   // Ą 0xa5 165
...
{0x00,0x3c,0x40,0x42,0x41,0x3c},   // Ş 0xaa 170
...
{0x00,0x3c,0x41,0x42,0x20,0x7c},   // Ż 0xaf 175
{0x00,0x00,0x06,0x09,0x09,0x06},   // ° 0xb0 176
{0x00,0x3c,0x41,0x40,0x21,0x7c},   // ± 0xb1 177
{0x00,0x4e,0x51,0x71,0x11,0x0a},   // ˛ 0xb2 178
{0x00,0x58,0x64,0x64,0x24,0x10},   // ł 0xb3 179
...
{0x00,0x30,0x48,0x45,0x40,0x20},   // ą 0xb9 185
{0x00,0x00,0x00,0x7b,0x00,0x00},   // ş 0xba 186
{0x00,0x38,0x44,0x44,0x38,0x44},   // » 0xbb 187
{0x00,0x40,0x3e,0x49,0x49,0x36},   // Ľ 0xbc 188
{0x00,0x08,0x04,0x08,0x70,0x0c},   // ˝ 0xbd 189
{0x00,0x60,0x50,0x48,0x50,0x60},   // ľ 0xbe 190
{0x00,0x20,0x52,0x55,0x59,0x30},   // ż 0xbf 191
{0x00,0x38,0x54,0x54,0x54,0x00},   // Ŕ 0xc0 192
{0x00,0x00,0x00,0x7f,0x41,0x00},   // Á 0xc1 193
{0x00,0x40,0x22,0x14,0x18,0x60},   // Â 0xc2 194
{0x00,0x7c,0x20,0x20,0x1c,0x20},   // Ă 0xc3 195
{0x00,0x44,0x3c,0x04,0x7c,0x44},   // Ä 0xc4 196
{0x00,0x40,0x3c,0x12,0x12,0x0c},   // Ĺ 0xc5 197
{0x00,0x41,0x63,0x55,0x49,0x41},   // Ć 0xc6 198
{0x00,0x38,0x44,0x44,0x3c,0x04},   // Ç 0xc7 199
{0x00,0x08,0x04,0x3c,0x44,0x24},   // Č 0xc8 200
{0x00,0x08,0x14,0x7f,0x14,0x08},   // É 0xc9 201
{0x00,0x4e,0x71,0x01,0x71,0x4e},   // Ę 0xca 202
{0x00,0x45,0x29,0x11,0x29,0x45},   // Ë 0xcb 203
{0x00,0x0d,0x51,0x51,0x51,0x3d},   // Ě 0xcc 204
{0x00,0x00,0x00,0x05,0x02,0x05},   // Í 0xcd 205
{0x00,0x40,0x00,0x40,0x00,0x40},   // Î 0xce 206
{0x00,0x00,0x08,0x1c,0x3e,0x00},   // Ď 0xcf 207
{0x00,0x1c,0x1c,0x1c,0x00,0x00},   // Đ 0xd0 208
{0x00,0x00,0x70,0x08,0x07,0x00},   // Ń 0xd1 209
{0x00,0x00,0x08,0x08,0x08,0x00},   // Ň 0xd2 210
{0x00,0x00,0x1d,0x15,0x17,0x00},   // Ó 0xd3 211
{0x00,0x00,0x07,0x05,0x07,0x00},   // Ô 0xd4 212
{0x00,0x00,0x11,0x15,0x0a,0x00},   // Ő 0xd5 213
{0x00,0x00,0x00,0x00,0x00,0x00},   // Ö 0xd6 214
{0x00,0x04,0x3c,0x41,0x20,0x00},   // × 0xd7 215
{0x00,0x7c,0x16,0x15,0x16,0x08},   // Ř 0xd8 216
{0x00,0x21,0x16,0x08,0x34,0x42},   // Ů 0xd9 217
{0x00,0x7f,0x09,0x1d,0x01,0x03},   // Ú 0xda 218
{0x00,0x38,0x54,0x54,0x14,0x08},   // Ű 0xdb 219
{0x00,0x00,0x00,0x7c,0x40,0x40},   // Ü 0xdc 220
{0x00,0x7f,0x0e,0x1c,0x38,0x7f},   // Ý 0xdd 221
{0x00,0x41,0x22,0x5d,0x22,0x1c},   // Ţ 0xde 222
{0x00,0x1c,0x3e,0x1c,0x08,0x00},   // ß 0xdf 223
{0x00,0x7f,0x7f,0x7f,0x7f,0x7f},   // ŕ 0xe0 224
{0x00,0x77,0x7b,0x01,0x7b,0x77},   // á 0xe1 225
{0x00,0x7f,0x43,0x75,0x43,0x7f},   // â 0xe2 226
{0x00,0x7f,0x6f,0x55,0x43,0x7f},   // ă 0xe3 227
{0x00,0x40,0x40,0x40,0x40,0x40},   // ä 0xe4 228
{0x00,0x44,0x42,0x5f,0x42,0x44},   // ĺ 0xe5 229
{0x00,0x40,0x5e,0x45,0x5e,0x40},   // ć 0xe6 230
{0x00,0x40,0x48,0x55,0x5e,0x40},   // ç 0xe7 231
{0x00,0x00,0x04,0x08,0x10,0x20},   // č 0xe8 232
{0x00,0x03,0x07,0x0e,0x1c,0x38},   // é 0xe9 233
{0x00,0x01,0x03,0x07,0x0f,0x1f},   // ę 0xea 234
{0x00,0x7c,0x78,0x70,0x60,0x40},   // ë 0xeb 235
{0x00,0x08,0x08,0x1c,0x22,0x1c},   // ě 0xec 236
{0x00,0x00,0x1c,0x22,0x1c,0x00},   // í 0xed 237
{0x00,0x02,0x00,0x08,0x00,0x20},   // î 0xee 238
{0x00,0x04,0x3e,0x3f,0x3e,0x04},   // ď 0xef 239
{0x00,0x10,0x3e,0x7e,0x3e,0x10},   // đ 0xf0 240
{0x00,0x55,0x2a,0x55,0x2a,0x55},   // ń 0xf1 241
{0x00,0x24,0x2a,0x7f,0x2a,0x12},   // ň 0xf2 242
{0x00,0x04,0x1e,0x1f,0x1e,0x04},   // ó 0xf3 243
{0x00,0x00,0x00,0x00,0x00,0x00},   // ô 0xf4 244
{0x00,0x00,0x00,0x00,0x00,0x00},   // ő 0xf5 245
{0x00,0x00,0x00,0x00,0x00,0x00},   // ö 0xf6 246
{0x00,0x00,0x00,0x00,0x00,0x00},   // ÷ 0xf7 247
{0x00,0x00,0x00,0x00,0x00,0x00},   // ř 0xf8 248
{0x00,0x00,0x00,0x00,0x00,0x00},   // ů 0xf9 249
{0x00,0x00,0x00,0x00,0x00,0x00},   // ú 0xfa 250
{0x00,0x00,0x00,0x00,0x00,0x00},   // ű 0xfb 251
{0x00,0x00,0x00,0x00,0x00,0x00},   // ü 0xfc 252
{0x00,0x00,0x00,0x00,0x00,0x00},   // ý 0xfd 253
{0x00,0x00,0x00,0x00,0x00,0x00},   // ţ 0xfe 254
